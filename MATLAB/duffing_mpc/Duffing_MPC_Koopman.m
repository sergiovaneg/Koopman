...
[C,D] = Koopman(G2,W(:,2:L+1),U,alpha,size(Y,1));

if cov_is_state
    if strcmp(obs_type,"radial")
        save(sprintf(data_source+'kk_cov_radial_M_%i.mat',M), ...
            "A","B","C","D","Ts","X0","n_x","n_w");
    elseif strcmp(obs_type,"polynomial")
        save(sprintf(data_source+'kk_cov_polynomial_P_%i.mat',M), ...
            "A","B","C","D","Ts","n_x","n_w","expts");
    end
else
    if strcmp(obs_type,"radial")
        save(sprintf(data_source+'kk_radial_M_%i.mat',M), ...
            "A","B","C","D","Ts","X0","n_x","n_w");
    elseif strcmp(obs_type,"polynomial")
        save(sprintf(data_source+'kk_polynomial_P_%i.mat',M), ...
            "A","B","C","D","Ts","n_x","n_w","expts");
    end
end
